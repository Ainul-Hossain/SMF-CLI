...
const AllAudio = ({MusicModalVisible, setMusicModalVisible}) => {
  console.log('From AllAudio.js...')
  const {setItem, currentTrack, setCurrentTrack} = useContext(Player)
      ...
      <FlatList
        ...
        renderItem={(
          ...
          <View style={styles.AllMusic_View}>
            ...
            {/* Google Adv Baner  */}
            {index === 4 && (
              <View style={styles.Google_Adv_View}>
                <TouchableOpacity
                  style={[
                    styles.googleAdvContainer,
                    {
                      width: WIDTH.width_100Per,
                      right: index % 2 === 0 ? null : '100%',
                    },
                  ]}>
                  <Image
